...
#LETFM (Letchworth Family Practice)
...
| Overview ||
|-----|-----|
| Data Source Name| **Letchworth Family Practice** |
| Data Source Acronym| **LETFM** |
| Type | **Clinical** |
| Site ID | **13** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|LETFM_PRESTAGING_PRD|
|User Name|LETFM_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0080-LETFM_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20LETFM%20or%20%22Data%20Source%20Acronym%22%20~%20LETFM)%20and%20status%20!%3D%20Closed)
