...
| Overview ||
|-----|-----|
| Data Source Name| **Lourdes** |
| Data Source Acronym| **LOURDES** |
| Type | **Clinical** |
| Site ID | **9** |
...
|-----|-----|
|Type|MSSQL|
|Host|neotwollehrsql0|
|Port|1433|
|Name|Works|
|User Name|sa_arcadia|  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20LOURDES%20or%20%22Data%20Source%20Acronym%22%20~%20LOURDES)%20and%20status%20!%3D%20Closed)
