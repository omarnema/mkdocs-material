...
#CAK (Community Physicians Associates (CPA) )
...
| Overview ||
|-----|-----|
| Data Source Name| **Community Physicians Associates (CPA) ** |
| Data Source Acronym| **CAK** |
| Type | **Clinical** |
| Site ID | **26** |
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20CAK%20or%20%22Data%20Source%20Acronym%22%20~%20CAK)%20and%20status%20!%3D%20Closed)
