...
| Overview ||
|-----|-----|
| Data Source Name| **Endwell Family Physicians** |
| Data Source Acronym| **EFP** |
| Type | **Clinical** |
| Site ID | **12** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|EFP_PRESTAGING_PRD|
|User Name|EFP_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0027-EFP_SFTP_PRD**.  
