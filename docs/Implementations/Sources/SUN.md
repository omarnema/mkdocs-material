...
| Overview ||
|-----|-----|
| Data Source Name| **Sunrise Pediatrics** |
| Data Source Acronym| **SUN** |
| Type | **Clinical** |
| Site ID | **32** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|SUN_PRESTAGING_PRD|
|User Name|SUN_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0115-PR-SUN_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20SUN%20or%20%22Data%20Source%20Acronym%22%20~%20SUN)%20and%20status%20!%3D%20Closed)
