...
| Overview ||
|-----|-----|
| Data Source Name| **Victor Health** |
| Data Source Acronym| **VIC** |
| Type | **Clinical** |
| Site ID | **21** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|VIC_PRESTAGING_PRD|
|User Name|VIC_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0105-PR-VIC_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20VIC%20or%20%22Data%20Source%20Acronym%22%20~%20VIC)%20and%20status%20!%3D%20Closed)
