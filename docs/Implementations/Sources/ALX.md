...
| Overview ||
|-----|-----|
| Data Source Name| **Alexander Medical Group** |
| Data Source Acronym| **ALX** |
| Type | **Clinical** |
| Site ID | **22** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|ALX_PRESTAGING_PRD|
|User Name|ALX_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0096-PR-ALX_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20ALX%20or%20%22Data%20Source%20Acronym%22%20~%20ALX)%20and%20status%20!%3D%20Closed)
