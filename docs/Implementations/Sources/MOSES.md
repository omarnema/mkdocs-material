...
| Overview ||
|-----|-----|
| Data Source Name| **Moses Lake** |
| Data Source Acronym| **MOSES** |
| Type | **Clinical** |
| Site ID | **15** |
...
The data for this connector is pulled from [Centricity 12](../../Tech_Delivery/EHR-Documentation/Centricity.md).
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20MOSES%20or%20%22Data%20Source%20Acronym%22%20~%20MOSES)%20and%20status%20!%3D%20Closed)
