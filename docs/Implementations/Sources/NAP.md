...
#NAP (Naples Valley Family Medicine)
...
| Overview ||
|-----|-----|
| Data Source Name| **Naples Valley Family Medicine** |
| Data Source Acronym| **NAP** |
| Type | **Clinical** |
| Site ID | **25** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|NAP_PRESTAGING_PRD|
|User Name|NAP_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0108-PR-NAP_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20NAP%20or%20%22Data%20Source%20Acronym%22%20~%20NAP)%20and%20status%20!%3D%20Closed)
