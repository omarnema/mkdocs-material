...
| Overview ||
|-----|-----|
| Data Source Name| **Legacy Pediatrics** |
| Data Source Acronym| **LGY** |
| Type | **Clinical** |
| Site ID | **36** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|LGY_PRESTAGING_PRD|
|User Name|LGY_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0119-PR-LGY_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20LGY%20or%20%22Data%20Source%20Acronym%22%20~%20LGY)%20and%20status%20!%3D%20Closed)
