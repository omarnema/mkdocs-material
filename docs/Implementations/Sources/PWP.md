...
| Overview ||
|-----|-----|
| Data Source Name| **Pathway Pediatrics ** |
| Data Source Acronym| **PWP** |
| Type | **Clinical** |
| Site ID | **28** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|PWP_PRESTAGING_PRD|
|User Name|PWP_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0111-PR-PWP_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20PWP%20or%20%22Data%20Source%20Acronym%22%20~%20PWP)%20and%20status%20!%3D%20Closed)
