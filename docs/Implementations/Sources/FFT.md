...
| Overview ||
|-----|-----|
| Data Source Name| **FF Thompson** |
| Data Source Acronym| **FFT** |
| Type | **Clinical** |
| Site ID | **23** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|FFT_PRESTAGING_PRD|
|User Name|FFT_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0106-PR-FFT_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20FFT%20or%20%22Data%20Source%20Acronym%22%20~%20FFT)%20and%20status%20!%3D%20Closed)
