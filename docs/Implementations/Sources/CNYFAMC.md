...
#CNYFAMC (Central New York Family)
...
| Overview ||
|-----|-----|
| Data Source Name| **Central New York Family** |
| Data Source Acronym| **CNYFAMC** |
| Type | **Clinical** |
| Site ID | **10** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|CNYFAMC_PRESTAGING_PRD|
|User Name|CNYFAMC_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0075-CNYFAMC_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20CNYFAMC%20or%20%22Data%20Source%20Acronym%22%20~%20CNYFAMC)%20and%20status%20!%3D%20Closed)
