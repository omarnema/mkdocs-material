...
| Overview ||
|-----|-----|
| Data Source Name| **Goodman Pediatrics** |
| Data Source Acronym| **GDP** |
| Type | **Clinical** |
| Site ID | **24** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|GDP_PRESTAGING_PRD|
|User Name|GDP_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0107-PR-GDP_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20GDP%20or%20%22Data%20Source%20Acronym%22%20~%20GDP)%20and%20status%20!%3D%20Closed)
