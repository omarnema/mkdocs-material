...
#KEU (Keuka Family Practice Associates)
...
| Overview ||
|-----|-----|
| Data Source Name| **Keuka Family Practice Associates** |
| Data Source Acronym| **KEU** |
| Type | **Clinical** |
| Site ID | **20** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|KEU_PRESTAGING_PRD|
|User Name|KEU_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0092-PR-KEU_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20KEU%20or%20%22Data%20Source%20Acronym%22%20~%20KEU)%20and%20status%20!%3D%20Closed)
