...
#STE (Cornerstone Medical Group (formerly Stern) )
...
| Overview ||
|-----|-----|
| Data Source Name| **Cornerstone Medical Group (formerly Stern) ** |
| Data Source Acronym| **STE** |
| Type | **Clinical** |
| Site ID | **38** |
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20STE%20or%20%22Data%20Source%20Acronym%22%20~%20STE)%20and%20status%20!%3D%20Closed)
