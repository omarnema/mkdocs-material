...
| Overview ||
|-----|-----|
| Data Source Name| **Dr. Lewis** |
| Data Source Acronym| **LEWIS** |
| Type | **Clinical** |
| Site ID | **14** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|LEWIS_PRESTAGING_PRD|
|User Name|LEWIS_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0079-LEWIS_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20LEWIS%20or%20%22Data%20Source%20Acronym%22%20~%20LEWIS)%20and%20status%20!%3D%20Closed)
