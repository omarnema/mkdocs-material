...
#STU (LGH Dr. Stupnytsi (Eagle Medicine Associates) )
...
| Overview ||
|-----|-----|
| Data Source Name| **LGH Dr. Stupnytsi (Eagle Medicine Associates) ** |
| Data Source Acronym| **STU** |
| Type | **Clinical** |
| Site ID | **72** |
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20STU%20or%20%22Data%20Source%20Acronym%22%20~%20STU)%20and%20status%20!%3D%20Closed)
