...
| Overview ||
|-----|-----|
| Data Source Name| **Dr. Yavorek** |
| Data Source Acronym| **YAV** |
| Type | **Clinical** |
| Site ID | **34** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|YAV_PRESTAGING_PRD|
|User Name|YAV_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0117-PR-YAV_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20YAV%20or%20%22Data%20Source%20Acronym%22%20~%20YAV)%20and%20status%20!%3D%20Closed)
