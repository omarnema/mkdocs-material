...
| Overview ||
|-----|-----|
| Data Source Name| **Elmwood Pediatrics** |
| Data Source Acronym| **LWD** |
| Type | **Clinical** |
| Site ID | **19** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|LWD_PRESTAGING_PRD|
|User Name|LWD_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0094-PR-LWD_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20LWD%20or%20%22Data%20Source%20Acronym%22%20~%20LWD)%20and%20status%20!%3D%20Closed)
