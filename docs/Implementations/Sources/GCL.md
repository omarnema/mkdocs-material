...
#GCL (Gastroenterology Consultants of Greater Lowell )
...
| Overview ||
|-----|-----|
| Data Source Name| **Gastroenterology Consultants of Greater Lowell ** |
| Data Source Acronym| **GCL** |
| Type | **Clinical** |
| Site ID | **18** |
...
|-----|-----|
|Type|MySQL|
|Host|BIDCO_EHRDB03.bidpoehr.local|
|Port|4932|
|Name|ECW_GCL|
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20GCL%20or%20%22Data%20Source%20Acronym%22%20~%20GCL)%20and%20status%20!%3D%20Closed)
