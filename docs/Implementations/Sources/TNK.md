...
| Overview ||
|-----|-----|
| Data Source Name| **Dr. Tinkelman** |
| Data Source Acronym| **TNK** |
| Type | **Clinical** |
| Site ID | **26** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|TNK_PRESTAGING_PRD|
|User Name|TNK_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0109-PR-TNK_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20TNK%20or%20%22Data%20Source%20Acronym%22%20~%20TNK)%20and%20status%20!%3D%20Closed)
