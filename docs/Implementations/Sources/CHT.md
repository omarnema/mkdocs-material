...
#CHT (Chittenango Medical & Wellness)
...
| Overview ||
|-----|-----|
| Data Source Name| **Chittenango Medical & Wellness** |
| Data Source Acronym| **CHT** |
| Type | **Clinical** |
| Site ID | **68** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|CHT_PRESTAGING_PRD|
|User Name|CHT_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0297-PR-CHT_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20CHT%20or%20%22Data%20Source%20Acronym%22%20~%20CHT)%20and%20status%20!%3D%20Closed)
