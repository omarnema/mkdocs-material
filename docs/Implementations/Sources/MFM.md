...
| Overview ||
|-----|-----|
| Data Source Name| **Marcellus Family Medicine** |
| Data Source Acronym| **MFM** |
| Type | **Clinical** |
| Site ID | **11** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|MFM_PRESTAGING_PRD|
|User Name|MFM_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0028-MFM_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20MFM%20or%20%22Data%20Source%20Acronym%22%20~%20MFM)%20and%20status%20!%3D%20Closed)
