...
| Overview ||
|-----|-----|
| Data Source Name| **Columbia Basin Health Association** |
| Data Source Acronym| **CBHA** |
| Type | **Clinical** |
| Site ID | **10** |
...
The data for this connector is pulled from [Centricity 10](../../Tech_Delivery/EHR-Documentation/Centricity.md).
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20CBHA%20or%20%22Data%20Source%20Acronym%22%20~%20CBHA)%20and%20status%20!%3D%20Closed)
