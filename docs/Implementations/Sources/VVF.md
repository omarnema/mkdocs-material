...
#VVF (Valley View Family Practice Associates)
...
| Overview ||
|-----|-----|
| Data Source Name| **Valley View Family Practice Associates** |
| Data Source Acronym| **VVF** |
| Type | **Clinical** |
| Site ID | **33** |
...
|Host|PRESTGSQLPRD01|
|Port|1433|
|Name|VVF_PRESTAGING_PRD|
|User Name|VVF_PRD_PRESTAGING|  
...
These files should be loaded from the folder **\\qdwsftp01\0116-PR-VVF_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20VVF%20or%20%22Data%20Source%20Acronym%22%20~%20VVF)%20and%20status%20!%3D%20Closed)
