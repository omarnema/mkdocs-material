...
| Overview ||
|-----|-----|
| Data Source Name| **Genesis Pediatrics** |
| Data Source Acronym| **GNS** |
| Type | **Clinical** |
| Site ID | **75** |
...
* AHP
    * AHP Community
			* Genesis Pediatrics
     			* Genesis Pediatrics Main Office
     			* Genesis Pediatrics - Unknown Location
...
These files should be loaded from the folder **\\qdwsftp01\0398-PR-GNS_SFTP_PRD**.  
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20GNS%20or%20%22Data%20Source%20Acronym%22%20~%20GNS)%20and%20status%20!%3D%20Closed)
- [Connector Deployment History](https://github.com/arcadia/qdw/wiki/connector-version)
- [Build Request](https://arcadia.box.com/s/7xohtfeduanlclsh1sslr9curnqvkeh3)
- [SOW](https://arcadia.box.com/s/81vmvio34xf2brxqw8u7)
- [DQA](https://arcadia.box.com/s/ixdqbc0sn8yb29qcjsfu7xcta8l1tj2a)
- [Connector Handoff](https://arcadia.box.com/s/ubk7qgzflg7m4obmxi43uvetwgkggx05)