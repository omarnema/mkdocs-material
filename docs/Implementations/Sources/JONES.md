...
| Overview ||
|-----|-----|
| Data Source Name| **Jones Memorial** |
| Data Source Acronym| **JONES** |
| Type | **Clinical** |
| Site ID | **17** |
...
The data for this connector is pulled from [Meditech 6](../../Tech_Delivery/EHR-Documentation/Meditech.md).
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20JONES%20or%20%22Data%20Source%20Acronym%22%20~%20JONES)%20and%20status%20!%3D%20Closed)
