...
#MIL (APG - Milton Group (Crown colony, ferante, vue) )
...
| Overview ||
|-----|-----|
| Data Source Name| **APG - Milton Group (Crown colony, ferante, vue) ** |
| Data Source Acronym| **MIL** |
| Type | **Clinical** |
| Site ID | **2** |
...
|-----|-----|
|Type|MySQL|
|Host|BIDCO_EHRDB02.bidpoehr.local|
|Port|4929|
|Name|ECW_MIL|
...
##External Documents
- [JIRA Open Issues](https://jira.arcadiasolutions.com/issues/?jql=(labels%20%3D%20MIL%20or%20%22Data%20Source%20Acronym%22%20~%20MIL)%20and%20status%20!%3D%20Closed)
